...
\IEEEcompsocitemizethanks{\IEEEcompsocthanksitem \textbf{Caue Duarte}: Programa de
Pós-Graduao em Computação,  Universidade Federal de Pelotas - UFPel, Centro de
Desenvolvimento Tecnológigo - CDTec.
% Para uma quebra de linha, deve-se utilizar o \protect antes do \\, caso contrrio vai
% dar erro.
\protect\\ E-mail: e-mailautor1@inf.ufpel.edu.br}

% No caso de mais autores, basta repetir:
\IEEEcompsocitemizethanks{\IEEEcompsocthanksitem \textbf{Alexandre Gomes da Costa}:
 Programa de Pós-Graduao em Computação,  Universidade Federal de Pelotas - UFPel, Centro
de Desenvolvimento
 Tecnológigo - CDTec.
...
\begin{abstract}
  Atingir consciência de situação é um grande desafio de pesquisa na área de Ubicomp, pois
  aplicações necessitam das informações contextuais para adaptar seu funcionamento. O trabalho
  apresenta um estudo sobre o uso de regras para prover consciência de situação, além de
  introduzir alguns dos principais conceitos referentes a computação ubíqua e consciência de
  situação, explorando o seu emprego em sistemas de grande porte em computação ubíqua.
\end{abstract}

\begin{IEEEkeywords}
Consciência de Situação, Sistemas baseados em regras, Ubicomp, Computação Ubíqua.
\end{IEEEkeywords}}
